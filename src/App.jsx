...
// Size options mapping for each category
const sizeOptions = {
    'Bedroom Furniture': {
        'Beds': ['King', 'Queen', 'Normal', 'Custom'],
        'Bedside Cupboards': ['Small', 'Medium', 'Large', 'Custom'],
        'Wardrobes': ['1 door', '2 door', '3 door', '4 door', 'Custom'],
        'Clothes Rack': ['Small', 'Medium', 'Large', 'Custom'],
        'Iron Table': ['Small', 'Big', 'Custom'],
        'Shoe Racks and Storage': ['Small', 'Medium', 'Large', 'Custom'],
        'Mattress': ['Single', 'Double', 'Triple', 'Queen', 'King', 'Custom'],
        'Pillows': ['Small', 'Medium', 'Large', 'Custom'],
        'Dressing Tables': ['Small', 'Medium', 'Large', 'Custom']
    },
    'Living Room Furniture': {
        'Sofa Sets': ['2 Seater', '3 Seater', '4 Seater', '5 Seater', '6 Seater', '7 Seater', '8 Seater', '9 Seater', '10 Seater', 'Custom'],
        'Coffee Tables and Side Tables': ['Small', 'Medium', 'Large', 'Custom']
    },
    'Dining Room Furniture': {
        'Dining Tables': ['Small', 'Medium', 'Large', 'Custom'],
        'Dining Chairs': ['Small', 'Medium', 'Large', 'Custom'],
        'Sideboards and Buffets': ['Small', 'Medium', 'Large', 'Custom']
    },
    'Office Furniture': {
        'Office Tables': ['Small', 'Medium', 'Large', 'Custom'],
        'Office Chairs': ['Small', 'Medium', 'Large', 'Custom'],
        'Cupboards and Racks': ['Small', 'Medium', 'Large', 'Custom'],
        'Study Desks': ['1 person', '2 person', 'Custom'],
        'Computer Tables': ['Small', 'Big', 'Custom']
    },
    'Outdoor Furniture': {
        'Garden Tables': ['Standard', 'Custom'],
        'Patio Chairs': ['Standard', 'Custom'],
        'Outdoor Sofa Set': ['Standard', 'Custom'],
        'Outdoor Storage Boxes': ['Standard', 'Custom']
    },
    'Storage Furniture': {
        'Book Shelves': ['Small', 'Medium', 'Large', 'Custom'],
        'Kitchen Cabinets': ['Small', 'Medium', 'Large', 'Custom'],
        'Wall-Mounted Shelves': ['Small', 'Medium', 'Large', 'Custom']
    },
    'Kids Furniture': {
        'Kids Beds': ['Single', 'Double', 'Triple', 'Custom'],
        'Study Tables': ['Small', 'Medium', 'Large', 'Custom'],
        'Toy Storage Units': ['Small', 'Medium', 'Large', 'Custom'],
        'Kids Wardrobes': ['Small', 'Medium', 'Large', 'Custom'],
        'Baby Cots': ['Small', 'Medium', 'Large', 'Custom']
    },
    'Home Decor & Accessories': {
        'Lamps and Lighting Fixtures': ['Table Lamps', 'Floor Lamps', 'Wall Sconces', 'Pendant Lights', 'Chandeliers', 'Custom'],
        'Wooden Decorative Items': ['Carved Figurines', 'Wall Art', 'Sculptures', 'Photo Frames', 'Coasters', 'Custom'],
        'Indoor Plants and Vases': ['Potted Plants', 'Succulents', 'Terrariums', 'Decorative Vases', 'Custom']
    }
};
...
const Add = ({ url, token, currency }) => {
    ...
    const onChangeHandler = (e) => {
        ...
        setData(prev => ({
            ...
            ...(name === 'category' && { subCategory: Object.keys(sizeOptions[value] || {})[0] || '' })
        }));
    };
    ...
    const availableSubCategories = Object.keys(sizeOptions[data.category] || []);
    
    // Get available sizes based on selected category and subcategory
    const availableSizes = sizeOptions[data.category]?.[data.subCategory] || [];
                    ...
                    {availableSizes.map(size => (
                        <div 
                            ...
                            className={`border px-4 py-2 rounded-full cursor-pointer ${
                                data.sizes.includes(size) ? 'bg-black text-white' : 'bg-gray-100'
                            }`}
                        >
                            {size}
                        </div>
